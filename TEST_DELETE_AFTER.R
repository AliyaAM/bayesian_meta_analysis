...
Results_Age = BayesUpdateStepByStep(x =x, Construct = "Age", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_Age)


Results_sixMWT = BayesUpdateStepByStep(x =x, Construct = "6MWT", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_sixMWT)

Results_Symptoms = BayesUpdateStepByStep(x =x, Construct = "Symptoms", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_Symptoms)


Results_LVEF = BayesUpdateStepByStep(x =x, Construct = "LVEF", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_LVEF)

Results_SelfEfficacy = BayesUpdateStepByStep(x =x, Construct = "SelfEfficacy", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_SelfEfficacy)

Results_SocialSupport = BayesUpdateStepByStep(x =x, Construct = "SocialSupport", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_SocialSupport)

Results_Comorbidity = BayesUpdateStepByStep(x =x, Construct = "Comorbidity", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_Comorbidity) 

Results_NegativeAttitute = BayesUpdateStepByStep(x =x, Construct = "NegativeAttitute", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_NegativeAttitute)

Results_Functioning = BayesUpdateStepByStep(x =x, Construct = "Functioning", uncertainty = 10, seed = 123456789754)
Results_BayesianMeta_Analysis = rbind(Results_BayesianMeta_Analysis, Results_Functioning)

Results_PositiveAttitute = BayesUpdateStepByStep(x =x, Construct = "PositiveAttitute", uncertainty = 10, seed = 123456789754)
