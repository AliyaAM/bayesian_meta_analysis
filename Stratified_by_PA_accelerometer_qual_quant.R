...
Summary_stats_table_qual_and_quantAccelerometerUnits_PositiveAttitude2  = Summary_stats_table_qual_and_quant(x = x, Construct = "PositiveAttitude")
Summary_stats_table_qual_and_quantResults_AccelerometerUnits_qual_quant = rbind(Summary_stats_table_qual_and_quantResults_AccelerometerUnits_qual_quant, Summary_stats_table_qual_and_quantAccelerometerUnits_PositiveAttitude2)


write.table(Results_AccelerometerUnits_qual_quant, file = paste(OUTPUT_ROOT, "Results_AccelerometerUnits_qual_quant.csv", sep=""), append = FALSE, quote = TRUE, sep = ", ",
...
write.table(Summary_stats_table_qual_and_quantResults_AccelerometerUnits_qual_quant, file = paste(OUTPUT_ROOT, "Summary_stats_table_qual_and_quantResults_AccelerometerUnits_qual_quant.csv", sep=""), append = FALSE, quote = TRUE, sep = ", ",
            eol = "\r", na = "NA", dec = ".", row.names = FALSE,
            col.names = TRUE, qmethod = c("escape", "double"),
            fileEncoding = "" )
...
data = Results_AccelerometerUnits_qual_quant
