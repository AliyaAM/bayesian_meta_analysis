...
Summary_stats_table_qual_and_quantIPAQ_scale_SelfEfficacy  = Summary_stats_table_qual_and_quant(x = x, Construct = "SelfEfficacy")
Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant = rbind(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant, Summary_stats_table_qual_and_quantIPAQ_scale_SelfEfficacy)



write.table(Results_IPAQ_scale_qual_quant, file = paste(OUTPUT_ROOT, "Results_IPAQ_scale_qual_quant.csv", sep=""), append = FALSE, quote = TRUE, sep = ", ",
...
write.table(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant, file = paste(OUTPUT_ROOT, "Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant.csv", sep=""), append = FALSE, quote = TRUE, sep = ", ",
            eol = "\r", na = "NA", dec = ".", row.names = FALSE,
            col.names = TRUE, qmethod = c("escape", "double"),
            fileEncoding = "" )
...
Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$QualplusQuantSD = sqrt(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$posterior_QualplusQuant_variance)


Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant = Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant %>% 
  mutate_if(is.numeric, round, digits = 2)


Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$prior_CI = paste("[", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Prior_qual_quantile_0.05, ";", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Prior_qual_quantile_0.95, "]", sep = "")
Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Prior_qual_quantile_0.05 = Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$prior_CI


Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_CI = paste("[", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_qual_quantile_0.05, ";", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_qual_quantile_0.95, "]", sep = "")
Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_qual_quantile_0.05 = Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_CI


Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_CI = paste("[", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_QualplusQuant_quantile_0.05, ";", Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_QualplusQuant_quantile_0.95, "]", sep = "")
Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_QualplusQuant_quantile_0.05 = Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_CI

Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant = data.frame(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Construct,
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Prior_qual_quantile_0.50,
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Prior_qual_quantile_0.05,
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_qual_quantile_0.50,
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Likelihood_qual_quantile_0.05,
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_QualplusQuant_quantile_0.50,	
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$Posterior_QualplusQuant_quantile_0.05, 
                                                                            Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant$QualplusQuantSD) 

colnames(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant) = c("Construct",
...
write.table(Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant, file = paste(folder, "_edited_Summary_stats_table_qual_and_quantResults_IPAQ_scale_qual_quant.csv", sep=""), append = FALSE, quote = TRUE, sep = ", ",
            eol = "\r", na = "NA", dec = ".", row.names = FALSE,
            col.names = TRUE, qmethod = c("escape", "double"),
            fileEncoding = "" )
...
ggsave(file = paste(folder, "/Compare_distributions_plot_IPAQ.pdf",  sep=""),Compare_distributions_plot, width=4, height=3, units="in", scale=3)
